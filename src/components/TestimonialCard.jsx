...
export default function TestimonialCard({ testimonial, index }) {
  return (
    <article className={`soft-card hover-lift relative p-7 sm:p-8 ${index === 1 ? 'md:translate-y-8' : ''}`}>
      <div className="flex items-center justify-between gap-4">
        <Quote className="text-blush/45" size={38} strokeWidth={1.25} aria-hidden="true" />
      ...
      <p className="mt-6 text-base leading-8 text-cocoa/76">"{testimonial.text}"</p>
      <div className="mt-7 border-t border-nude/55 pt-5">
