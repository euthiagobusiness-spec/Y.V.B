...
export default function Hero({ brand, ctas }) {
  return (
    <section id="inicio" className="relative overflow-hidden pb-14 pt-6 sm:pb-16 sm:pt-8 lg:pb-20 lg:pt-10">
      ...
      <div className="section-shell grid items-center gap-8 lg:grid-cols-[1.06fr_0.94fr] lg:gap-10">
        <div className="relative reveal-soft">
          ...
          <h1 className="max-w-3xl font-display text-[2.85rem] font-semibold leading-[0.92] text-cocoa sm:text-[3.9rem] lg:text-[5rem]">
            Sua
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-cocoa/80 sm:text-lg sm:leading-8">
          ...
          <GlassCard
            className="mt-5 max-w-3xl rounded-[1.35rem] p-4 text-xs font-semibold text-cocoa/88 sm:p-5 sm:text-sm"
            contentClassName="relative z-10 grid grid-cols-3 gap-2 sm:gap-3"
          >
            {['Escuta antes do procedimento', 'Resultado leve e natural', 'Horário marcado'].map((item) => (
              <span key={item} className="flex min-h-[4.75rem] items-center justify-center rounded-2xl bg-white/42 px-2 py-3 text-center leading-snug sm:px-4">
                {item}
              </span>
            ))}
          </GlassCard>
        ...
        <div className="relative mx-auto w-full max-w-[27rem] reveal-soft [animation-delay:120ms]">
          ...
          <GlassCard className="glass-shimmer relative overflow-hidden rounded-[1.75rem] p-3 sm:p-4">
            ...
            <div className="glass-card rounded-[1.5rem] p-4 sm:p-5">
              <div className="glass-card relative flex min-h-[17rem] flex-col justify-between overflow-hidden rounded-[1.35rem] p-5 sm:min-h-[19rem] sm:p-6">
                ...
                <div>
                  <p className="font-display text-4xl font-semibold leading-none text-cocoa sm:text-6xl">
                    Beleza natural
                  </p>
                  <p className="mt-4 max-w-xs text-xs font-bold uppercase tracking-[0.28em] text-blush">
                    Cuidado • Confiança • Leveza
                  </p>
                </div>

                <div className="flex items-end justify-between gap-5">
                  <p className="max-w-[12rem] text-sm leading-6 text-cocoa/62">
          ...
          <a
            ...
            className="group relative z-10 mx-auto -mt-7 grid w-full max-w-[27rem] grid-cols-[1.75rem_minmax(0,1fr)_2.75rem] items-center gap-3 rounded-[1.35rem] border border-white/28 bg-cocoa px-5 py-4 text-white shadow-[0_18px_42px_rgba(90,60,58,0.2)] transition duration-300 hover:-translate-y-1 hover:bg-[#4d302e] focus:outline-none focus:ring-2 focus:ring-gold/70 focus:ring-offset-2 focus:ring-offset-ivory sm:-mt-8 sm:max-w-[32rem] sm:grid-cols-[2.35rem_minmax(0,1fr)_3rem] sm:gap-4 sm:px-6 sm:py-5"
          >
            ...
            <div className="relative min-w-0 self-center">
              <p className="text-[0.62rem] font-bold uppercase leading-none tracking-[0.26em] text-white/76">Agendamento</p>
              <p className="mt-2 whitespace-nowrap font-display text-[1.22rem] font-semibold leading-none text-white min-[480px]:text-[1.28rem] sm:text-[1.62rem]">pronta para cuidar de você?</p>
            </div>
